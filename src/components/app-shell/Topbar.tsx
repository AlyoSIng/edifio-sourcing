 ...
 *
 * Server Component pour le rendu, avec sous-composant Client `SignOutButton`
 * (besoin d'un onClick + appel `/auth/sign-out` côté browser).
 */
...
export function Topbar({ user }: TopbarProps) {
  ...
  return (
    <header
      className="flex items-center justify-end gap-3 border-b border-line bg-white px-4 py-3 md:px-6"
      role="banner"
    >
