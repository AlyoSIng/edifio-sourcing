  ...
  switch (code) {
    ...
    case "server_error":
      return {
        ...
        message:
          "Une erreur technique côté serveur d'authentification est survenue. Réessaye dans quelques instants — si le problème persiste, contacte l'éditeur à sebastien@edifio.fr.",
    ...
    default:
      return {
        ...
        message:
          "Une erreur est survenue pendant l'authentification. Réessaye depuis la page de connexion. Si le problème persiste, contacte l'éditeur à sebastien@edifio.fr.",
        actionLabel: "Retour à la connexion",
        actionHref: "/login",
      };
  }
