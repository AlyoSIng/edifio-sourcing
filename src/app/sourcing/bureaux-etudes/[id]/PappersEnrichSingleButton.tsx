...
/**
 * PappersEnrichSingleButton — enrichissement Pappers unitaire pour la fiche BE.
 *
 * Appelle la Server Action `enrichSingleBEFromPappers` et affiche
...
import { enrichSingleBEFromPappers } from "../actions";
...
export function PappersEnrichSingleButton({ beId }: Props) {
  ...
  function handleClick() {
    startTransition(async () => {
      setState("pending");
      const res = await enrichSingleBEFromPappers(beId);
      if (res.ok) {
